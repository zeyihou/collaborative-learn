...
Notice: We use the two configurations of ```DCGAN & CIFAR-10''' and ```BigGAN & ImageNet-100``` as examples.
        Other architectures can also be adapted to fit our algorithm as it is model agnostic.
